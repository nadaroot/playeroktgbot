...
TOPIC_CHATS = DataFile(
    name="topic_chats",
    path="bot_data/topic_chats.json",
    default={
        "chat_to_topic": {},
        "topic_to_chat": {}
    }
)
ONE_TIME_CODES = DataFile(
    name="one_time_codes",
    path="bot_data/one_time_codes.json",
    default={}
)
DATA = [INITIALIZED_USERS, SAVED_ITEMS, CACHED_ORDERS, BUMPED_ITEMS, TOPIC_CHATS, ONE_TIME_CODES]
