...
def profile_text():
    ...
    if not plbot or not getattr(plbot, "account", None) or not getattr(plbot.account, "profile", None):
        return textwrap.dedent("""
            <b>👤 Мой профиль</b>

            ⚠️ <b>Playerok аккаунт не подключён</b>
            Пожалуйста, укажите Cookie-данные в разделе <b>Настройки ⚙️ ➔ Авторизация 🔒</b>.
        """).strip()
